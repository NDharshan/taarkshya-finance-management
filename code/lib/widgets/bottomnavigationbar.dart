...
List<String> s = ['Income', "Expend", 'Coupon', 'Sudexo', 'Gift Card'];
List<double> d = [26, 32, 26, 32, 26];

class _BottomState extends State<Bottom> {
  int index_color = 0;
  List Screen = [Home(), Statistics(), Visualize(s, d), Home()];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Color.fromRGBO(219, 103, 82, 1),
      ),
